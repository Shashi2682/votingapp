...
export default class Registration extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      // Set web3, accounts, and contract to state, and then proceed with an example of interacting with the contract's methods.
      this.setState({
        web3: web3,
      ...
      const admin = await instance.methods.admin().call(); // Corrected to access admin address directly
      ...
      // Loading current voter details
      const currentVoter = await instance.methods.voterDetails(this.state.account).call();
      this.setState({
        currentVoter: {
...
// Display the current voter's details
